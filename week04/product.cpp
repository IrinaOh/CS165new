...
***********************************************************************/
// CODE REVIEW: Avoid magic numbers in getTax and getShipping. Instead, assign them
//   to variables with a comment on why you chose that specific number. (-2)
//   While your comments help, it's too easy for comments and code to get out of sync
